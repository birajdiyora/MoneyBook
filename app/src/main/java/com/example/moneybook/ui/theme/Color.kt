...
val closing_balance_green = Color(0xFF0DAD15)
val closing_balance_red = Color.Red
val closing_balance_red_dark_theme = Color(0xFFFA3F3A)
val amount_dialog_title_green = Color(0xFF06830C)
